...
SECTORES = {
    ...
    "ETFs": [
        # ---- TOP LIQUIDITY CORE (Inclusión garantizada) ----
    "SPY", "VOO", "IVV", "QQQ", "QQQM", "IWM", "TLT", "GLD", 
    
    # ---- RESTO DEL UNIVERSO CONSOLIDADO (Alfabético) ----
    "AAAU", "AAXJ", "ACES", "ACWI", "ACWX", "AFK", "AGG", "AIA", "AIQ", "AKRW", 
    "AMJ", "AMLP", "AMZA", "ANGL", "ARGT", "ARKG", "ARKQ", "ARKK", "ASHR", "ATMP", 
    "AWAY", "AWP", "BAL", "BAR", "BATT", "BBH", "BBP", "BFOR", "BIB", "BIL", 
    "BIS", "BJK", "BLCN", "BLOK", "BND", "BNDX", "BNO", "BOTZ", "BUG", "CIBR", 
    "CHIE", "CHIQ", "CLOU", "CNDA", "CNCR", "CNERG", "CNYA", "COPX", "CORP", "COW", 
    "COWZ", "CPER", "CQQQ", "CRBN", "CRUZ", "CUT", "CXSE", "DBA", "DBB", "DBC", 
    "DBEF", "DEM", "DFEN", "DGRO", "DGS", "DIA", "DRIV", "DSI", "DVY", "DXJ", 
    "EAGG", "EALV", "EAW", "ECH", "EDEN", "EDIV", "EDV", "EEM", "EEMA", "EFA", 
    "EFAV", "EFEA", "EFG", "EFV", "EGPT", "ELD", "EMB", "EMGF", "EMLG", "EMLP", 
    "ENFR", "EPP", "EPU", "EPY", "EZA", "FAD", "FALN", "FAN", "FBK", "FBT", 
    "FCOM", "FDN", "FEMA", "FEMS", "FENY", "FILL", "FINX", "FITE", "FLOT", "FLRN", 
    "FM", "FNDA", "FNDB", "FNDC", "FNDE", "FNDF", "FNDX", "FOXW", "FPE", "FREL", 
    "FRI", "FRN", "FSD", "FSG", "FTSD", "FTSM", "FVD", "FXI", "FXO", "GAF", 
    "GAMR", "GDX", "GDXJ", "GEM", "GID", "GIGB", "GLDM", "GML", "GOVT", "GRID", 
    "GXC", "GXG", "HACK", "HAIL", "HAUS", "HCLN", "HDV", "HEAL", "HEFA", "HEWJ", 
    "HERO", "HFXI", "HOMZ", "HYG", "HYGZ", "HYLB", "HYS", "HYXF", "IAI", "IAT", 
    "IAU", "IBB", "IBUY", "ICF", "ICLN", "ICSH", "IDNA", "IDRV", "IDX", "IEF", 
    "IEI", "IEMA", "IEO", "IEUR", "IEZ", "IFGL", "IGLB", "IGSB", "IGV", "IHE", 
    "IHI", "IHAK", "IJK", "IJJ", "IJR", "IJS", "ILF", "INDA", "INDS", "IPAC", 
    "IPAY", "IRBO", "ITA", "ITB", "IVW", "IWB", "IWC", "IWD", "IWE", "IWF", 
    "IWG", "IWN", "IWO", "IWP", "IWR", "IWS", "IWV", "IXC", "IYF", "IYG", 
    "IYH", "IYJ", "IYK", "IYM", "IYR", "IYT", "IYW", "IYX", "JETS", "JKF", 
    "JKG", "JKH", "JKI", "JKK", "JO", "JPST", "KARS", "KBA", "KBRW", "KBWB", 
    "KBWP", "KBWR", "KBWY", "KIE", "KLD", "KOMP", "KRE", "KSA", "KWEB", "LABD", 
    "LABU", "LD", "LEGR", "LEMB", "LIT", "LKOR", "LOUP", "LOWC", "LQD", "MBB", 
    "MCHI", "MDY", "MDYG", "MDYV", "MES", "MINT", "MISL", "MLP", "MLPA", "MLPX", 
    "MOO", "MOON", "MORT", "MTUM", "MUB", "NEAR", "NETL", "NFC", "NGE", "NIB", 
    "NLR", "NOBL", "NUKZ", "NUMG", "OEF", "OIH", "OLD", "ONLN", "OUNZ", "PALL", 
    "PBD", "PBDM", "PBW", "PCY", "PDBC", "PEJ", "PEX", "PFF", "PFFD", "PFFR", 
    "PHE", "PHO", "PICK", "PLAT", "PPLT", "PPA", "PPCH", "PPTY", "PRNT", "PRW", 
    "PSJ", "PSK", "PULS", "PXE", "PXI", "QAT", "QCLN", "QLTA", "REET", "REM", 
    "REMX", "REZ", "RGI", "RHS", "RNRG", "ROBO", "RYE", "RYF", "RYH", "RYT", 
    "RYU", "SAB", "SBIO", "SCHA", "SCHB", "SCHC", "SCHD", "SCHE", "SCHF", "SCHG", 
    "SCHH", "SCHI", "SCHJ", "SCHM", "SCHO", "SCHP", "SCHQ", "SCHR", "SCHV", "SCHW", 
    "SCHX", "SCHZ", "SCZ", "SDY", "SFE", "SGOL", "SGOV", "SHE", "SHV", "SHY", 
    "SHYG", "SIL", "SIVR", "SKYY", "SLQD", "SLV", "SLY", "SLYG", "SLYV", "SMH", 
    "SMOG", "SNPE", "SOCL", "SORE", "SOXX", "SPIB", "SPLB", "SPLG", "SPSB", 
    "SPYD", "SPYG", "SPYM", "SPYV", "SPYX", "SREI", "SRET", "SRVR", "SUSA", 
    "SUSC", "SUSD", "SUSL", "TAN", "TFLO", "THD", "TIP", "TLH", "SPLG", "TPAY", 
    "TPYP", "TUR", "UAE", "UNG", "URA", "USFR", "USHY", "USIG", "USMV", "USO", 
    "USRT", "USSG", "VAW", "VB", "VBR", "VBK", "VCAR", "VCIT", "VCLT", "VCR", 
    "VCSH", "VDC", "VDE", "VEA", "VEGI", "VFH", "VGIT", "VGK", "VGLT", "VGSH", 
    "VGT", "VHT", "VIG", "VIOO", "VIOG", "VIOV", "VIS", "VNM", "VNQ", "VONE", 
    "VONG", "VONV", "VOX", "VPU", "VRIG", "VRP", "VTEB", "VTHR", "VTI", "VTIP", 
    "VTWO", "VUG", "VUSE", "VXUS", "VWOB", "WCBR", "WCLD", "WIL", "WOMN", "WOOD", 
    "WREI", "XAR", "XBI", "XLB", "XLC", "XLE", "XLF", "XLK", "XLI", "XLP", 
    "XLRE", "XLU", "XLV", "XLY", "XOP", "XPH", "XSD", "XSW", "XTL", "XTN", 
    "ZROZ"
