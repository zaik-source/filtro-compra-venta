...
SECTORES = {
    ...
    "Financial": [
        ...
        "RY", "SAN", "SMFG", "TD", "UBS", "WFC", "GS", "MS", "SCHW", "COIN",
        "MARA", "RIOT", "HOOD", "IBKR", "MA", "V", "PYPL", "AFRM", "SOFI", "UPST",
        "CBOE", "CME", "ICE", "NDAQ", "SPGI", "MCO", "MSCI", "BLK", "KKR", "APO",
        "BX", "TPG", "OWL", "ARES", "PGR", "TRV", "ALL", "CB", "MET", "PRU",
        "AIG", "HIG", "AFL", "AXP", "COF", "SYF", "ZION", "KEY", "RF", "USB",
        "PNC", "TFC", "MTB", "CFG", "HBAN", "FITB", "STT", "BNY", "NTRS",
    ],
    "ETFs": [
    ...
    "Healthcare": [
        ...
        "AMGN", "AZN", "BAX", "BIIB", "BMY", "BSX", "CAH", "CI", "CNC", "CVS",
        "DHR", "DXCM", "ELV", "EW", "GEHC", "GILD", "GSK", "HCA", "HIMS", "HUM",
        "IDXX", "ILMN", "INCY", "ISRG", "JNJ", "LH", "LLY", "MCK", "MDT", "MRK",
        "MRNA", "NVO", "NVS", "PFE", "PHG", "REGN", "RMD", "RVTY", "SYK", "TAK",
        "TDOC", "TMO", "UNH", "VEEV", "VRTX", "WAT", "ZBH", "ZTS",
        "CRSP", "EDIT", "BEAM", "NTLA", "ARWR", "IONS", "ALNY", "SRPT", "BMRN",
        "RARE", "NBIX", "INCY", "JAZZ", "EXEL", "SGEN", "ACAD", "SAGE", "NKTR",
        "AGEN", "ARGX", "RVMD", "KYMR", "KRYS", "SMMT", "NUVL", "TGTX", "PRAX",
    ],
    "Industrials": [
