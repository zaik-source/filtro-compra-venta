...
SECTORES = {
    ...
    "Energy": [
        "APA", "AR", "BKR", "BP", "COP", "CTRA", "CVX", "DVN", "EOG", "EQT",
        "FANG", "HAL", "HES", "KMI", "LNG", "MPC", "MRO", "NOV", "OKE", "OXY",
        "PDCE", "PSX", "PXD", "RRC", "SLB", "SUN", "TRGP", "VLO", "WMB", "XOM",
    ],
...
with st.sidebar:
    ...
    rsi_sv      = st.slider("RSI Sobrevendido",  20, 40, 50)
